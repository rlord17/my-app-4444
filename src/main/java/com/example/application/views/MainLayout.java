...
import com.example.application.views.helloworld3.HelloWorld3View;
...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(HelloWorld3View.class)) {
            nav.addItem(new SideNavItem("Hello World3", HelloWorld3View.class, LineAwesomeIcon.GLOBE_SOLID.create()));
